...
## 搜索引擎结果屏蔽器
[Github](https://raw.githubusercontent.com/SadYuyuko/Search-Engine-Result-Hider/refs/heads/main/Search-Engine-Result-Hider.js) | [Greasy Fork](https://greasyfork.org/zh-CN/scripts/552394) 使用任意脚本管理器安装  
...
2.搭配永页机使用时，在加载页面时刚好第一页所有结果都被屏蔽会导致无限加载或空白结果，解决方法是启用翻页预读使其提前加载出后续页面。自动拼接后屏蔽数量显示为0但不影响屏蔽功能 
